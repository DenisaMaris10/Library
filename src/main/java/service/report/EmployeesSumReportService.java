...
public class EmployeesSumReportService implements ReportGenerationService{
    private final ReportGenerationRepository reportGenerationRepository;

    public EmployeesSumReportService(ReportGenerationRepository reportGenerationRepository){
    ...
    public void generateReport(String month) {
        ...
        List<UserReport> userReportList = reportGenerationRepository.findAllOrdersWithSum(month);
    ...
    private static void addTableHeader(PdfPTable table) {
        Stream.of("UserId", "Username", "Total Incasari")
                .forEach(columnTitle -> {
